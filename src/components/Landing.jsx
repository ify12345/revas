import logo from "../assets/images/Frame 6.png";
import { AiOutlineArrowRight } from "react-icons/ai";
import img from "../assets/images/Recyclates.png";
...
import img5 from "../assets/images/small2.png";
import img6 from "../assets/images/small3.png";
...
const Landing = () => {
  ...
  const selected =
    active === "bales"
      ? "bg-white text-black rounded-[100px] border-black border-2"
      : "";
  const selected2 =
    active === "flakes"
      ? "bg-white text-black rounded-[100px] border-black border-2"
    ...
    <div className="h-screen">
      <section className="bg-black w-full h-full">
        ...
        <nav className="text-white flex justify-between py-24 px-5 md:px-10 items-center w-full gap-6 md:gap-2">
          ...
          <Link
            to="/waitlist"
            className="rounded-3xl bg-white flex justify-between items-center border border-white text-black gap-2 max-w-[228px] py-3 px-5"
          >
        ...
        <section className="text-white flex flex-col max-w-full h-auto pb-40 md:pb-64 w-full relative">
          <div className="mx-auto flex flex-col max-w-screen-xl gap-4 px-5 md:px-10 lg:px-20">
            <p className="w-full max-w-[1000px] font-urbanist lg:text-[80px] text-center relative top-0 z-10">
            ...
            <Link
              to="/waitlist"
              className="mx-auto max-w-[228px] rounded-3xl bg-white flex items-center border border-white text-black gap-2 py-3 px-5"
            >
          ...
          <section className="w-screen  flex flex-col">
            ...
            <div className="w-full">
              <div className=" flex justify-center gap-[9px] text-center md:gap-[18px] bg-black text-white rounded-[100px] max-w-fit mx-auto items-start">
                <p
                  onClick={Bales}
                  className={`"p-[8px] p-[80px] md:p-[16px] md:p-[16px]" ${selected}`}
                >
                  Plastic Bales
                </p>
                <p
                  onClick={Flakes}
                  className={`"p-[8px] p-[80px] md:p-[16px] md:p-[16px]" ${selected2}`}
                >
                  Plastic Flakes
                </p>
                <p
                  onClick={Pellets}
                  className={`"p-[8px]  p-[80px] md:p-[16px] md:p-[16px]" ${selected3}`}
                >
                  Plastic Pellets
                </p>
              </div>
            ...
            <div className="mt-[30px] border border-[#F2F2F4] bg-[#F2F2F4] mx-[45px] xl:mx-[90px] max-w-full grid grid-cols-1 xl:grid-cols-2 auto-cols-[630.5px] items-center gap-[50px] xl:gap-[155px] p-[40px] md:p-[99px]">
              <div className="flex flex-col gap-[10px]  xl:gap-[38px] max-h-auto max-w-full">
                ...
                <Link
                  to="/signup"
                  className="flex text-white bg-black items-center gap-[10px] rounded-[50px] max-w-[151px]  lg:py-[16px] px-[32px]"
                >
            ...
            <div className="bg-black text-white p-[45px] xl:p-[90px] w-full flex flex-col gap-[30px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 auto-cols-[406px] gap-[20px]">
                ...
                <div className="flex flex-col gap-[23px]">
                  ...
                  <p className="text-[28px] leading-[36px] font-[600] max-w-[356px]">
                    Secure Transactions with Our Escrow Service
                  </p>
                  <p className="text-[20px] leading-[26px] font-[400] max-w-[356px]">
                    We enable transactions to be efficient, transparent, and
                    secure through our escrow service.
                  </p>
                  <Link className="leading-[26px] text-[20px] font-[400]">
                    Learn more
                  </Link>
                </div>
                {/* grid2 */}
                ...
                <div className="flex flex-col gap-[23px]">
                  ...
                  <p className="text-[20px] leading-[26px] font-[400] max-w-[356px]">
                    We provide data analytics and quality control services to
                    help optimize the value of plastic waste.
                  </p>
                  <Link className="leading-[26px] text-[20px] font-[400]">
                    Learn more
                  </Link>
            ...
            <div className="bg-[#F2F2F4] h-auto max-w-full py-[50px] md:py-[160px] px-[20px] md:px-[45px] gap-3 md:gap-0 grid  grid-cols-1 md:grid-cols-2 border auto-cols-[645px]">
              <div className="bg-black text-white border border-black rounded-3xl md:rounded-l-3xl md:rounded-r-none relative p-[70px] flex flex-col gap-[38px]">
                ...
                <p className="max-w-[496px] text-[27px] md:text-[52px] md:leading-[59px] font-[600]">
                  Creating a sustainable future for everyone
                </p>
                <p className="max-w-[496px] text-[16px] font-[400] leading-[20.8px]">
                  We envision a world where plastic waste is transformed into a
                  valuable resource, creating a circular economy that benefits
            ...
            <div className="bg-black gap-[53px] h-full  grid grid-cols-1  p-[22px] md:p-[45px] text-white text-[7px] md:text-[16px] leading-[20px]">
              ...
              <div className="flex flex-row justify-between items-center">
                ...
                <button className="bg-transparent text-white flex gap-3 rounded-[100px] items-center border-white border px-[12px]  md:px-[30px] py-[10px] md:py-[20px]">
