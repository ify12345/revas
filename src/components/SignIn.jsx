  ...
  return (
    <section className="w-screen h-screen">
      ...
      <div className="max-w-[460px] flex flex-col justify-center mx-[40px] sm:mx-auto h-full gap-8">
        <p className="text-[2rem] max-w-[442px] font-[600] leading-[40px] text-center">
          Sign in to revas
        </p>
        ...
        <form className="max-w-full flex flex-col gap-6" action="">
          <div className="max-w-full flex flex-col">
            ...
            <input
              className="max-w-full px-[16px] py-[8px] border rounded-[50px]"
              type="text"
              placeholder="Company"
            />
          </div>
          ...
          <Link
            to="/dashboard"
            className="max-w-full flex items-center justify-center gap-3 bg-black text-white rounded-[50px] py-[12px]"
          >
            Login
        ...
        <div className="flex max-w-full items-center justify-center">
          ...
          <Link to="/signup" className="font-[700]">
            Sign up
          </Link>
        </div>
      </div>
