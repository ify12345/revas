...
const SignUp = () => {
  return (
   <section className="w-screen text-[10px] lg:text-[16px] h-screen">
        ...
        <main className="max-w-full flex mx-[20px] lg:mx-0">
           <div className="max-w-[100%] lg:max-w-[60%] flex flex-col justify-center mx-auto gap-6">
            ...
            <p className="max-w-[416px] text-[0.8rem] leading-[20px] text-center">You are only a few steps away from creating your account.</p>
             <form className="max-w-full flex flex-col gap-6" action="">
                ...
                <button className="max-w-full flex items-center justify-center gap-3 bg-black text-white rounded-[50px] py-[12px]">Register<AiOutlineArrowRight size={10} /></button>
             </form>
           ...
           {/* image */}
           <div className=" max-w-[0%] lg:max-w-[40%]">
