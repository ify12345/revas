        ...
        <main className="w-[500px] flex flex-col gap-[10px]">
           ...
           <div className="max-w-full gap-[20px] flex flex-col">
             ...
             <form className=" flex flex-col gap-[10px]" action="">
                 ...
                 <button className="max-w-full bg-white text-black flex items-center rounded-[50px] justify-center gap-3 py-[16px] px-[16px]">Join the waitlist <AiOutlineArrowRight size={10} /></button>
             </form>
           </div>
